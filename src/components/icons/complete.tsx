...
export function CompleteOutlined({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
...
export function CompleteFilled({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
    console.warn(`The size prop (${size}) should be a multiple of 8.`)
  }
