...
export function MeOutlined({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
...
export function MeFilled({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
    console.warn(`The size prop (${size}) should be a multiple of 8.`);
  }
