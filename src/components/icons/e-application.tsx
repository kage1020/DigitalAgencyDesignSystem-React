...
export function EApplicationOutlined({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
  ...
  return (
    <svg
      ...
      viewBox='0 0 25 25'
      fill='none'
      data-testid='e-application-outlined'
    >
...
export function EApplicationFilled({ className, size = 24, color }: IconProps) {
  if (size % 8 !== 0) {
    console.warn(`The size prop (${size}) should be a multiple of 8.`);
  }
  ...
  return (
    <svg
      ...
      viewBox='0 0 25 25'
      fill='none'
      data-testid='e-application-filled'
    >
